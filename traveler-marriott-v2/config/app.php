...
return [
    ...
    */
    'autoload' => [
        ...
        'Http/assets.php',
        'Http/ajaxes.php',
        'Http/JSONManifest.php',
        'Http/AsyncDeferScripts.php',
        'Http/ModuleNoModuleScripts.php',
        'Setup/actions.php',
        'Setup/filters.php',
        'Setup/supports.php',
        'Setup/services.php',
        ...
        'Plugins/AdvancedCustomFields.php',
        'Plugins/AdRotate.php',
        'Plugins/WordPresSEO.php',
        'Admin/cache.php',
        'Admin/admin.php',
    ],
];
